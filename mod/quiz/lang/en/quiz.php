...
$string['messageprovider:precreate_failed'] = 'Quiz precreate failed';
...
$string['precreatefailed:body:finish'] = 'These errors are likely to prevent students starting their quiz. Please investigate and resolve these issues before each quiz opens';
$string['precreatefailed:body:reason'] = 'Failure reason: {$a}';
$string['precreatefailed:body:start'] = 'One or more quizzes could not have attempts pre-created. See below for more details. Failure count: {$a->count}.';
$string['precreatefailed:subject'] = 'Quizzes failed to pre-create their attempts.';
...
$string['quiz:emailfailedprecreate'] = 'Receive notification when a quiz has failed to precreate attempts';
