...
$string['precreatefailed:body:finish'] = 'These will need to be investigated/corrected before the quiz/quizzes can start.';
$string['precreatefailed:body:reason'] = 'Failure reason: {$a}';
$string['precreatefailed:body:start'] = 'The following {$a->count} quiz/quizzes have failed the attempt pre-creation process with the relevant reason:';
